...
if(isset($_GET['go']))
{
    ...
    $_SESSION['id'] = $value;
    header('Location:securityAdminAdd.blade.php');
...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <form action="securityAdminInsert.blade.php" method="get">
    <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <?php
                    ...
                    $query = "SELECT * FROM employeerequest";
                    $res = mysqli_query($db,$query);
                    while($row = mysqli_fetch_array($res)){
                        if($row['type'] == "medical"){
                        $str.="<tr>";
                       
                        $str.="<td class='data'><input type='radio' class='selectbtn' name='select' value='".$row['id']."'></td>";
                        ...
                        $str.="<td class='data'>".$row['specialty']."</td>";
                        $str.="</tr>";
