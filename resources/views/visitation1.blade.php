    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <div style="margin-top:50px;">
            ...
            <form action="visitation1.blade.php" method="get">
                <div background-color:black;>
                    
                    <div>
                        <input type="text" class="inp" name="visitor" placeholder="Visitor Name">
                    </div>
                    <div>
        ...
        <table class="table table-dark table-striped">
            <thead>
                <tr class="rowhead">
                    <th class="colhead">Prisoner ID</th>
            ...
            <tbody>
                ...
                {
                    $str="";
                    $query="SELECT visited_prisoner_id,visitor_name,visited_time,relationship,phone_no,visitations.address FROM visitations WHERE visitor_name LIKE '".$_GET['visitor']."%' AND visited_prisoner_id IN 
(SELECT pid from biodata)";                    
                  $res = mysqli_query($db,$query);
                    ...
                    while($row = mysqli_fetch_array($res) ){
                        ...
                        $str.="<td class='data'>".$row['visited_prisoner_id']."</td>";
        $str.="<td class='data'>".$row['visitor_name']."</td>";
        $str.="<td class='data'>".$row['relationship']."</td>";
        $str.="<td class='data'>".$row['visited_time']."</td>";
        $str.="<td class='data'>".$row['phone_no']."</td>";
