<?php
    ...
    $getUser = "SELECT biodata.NAME,offense,age,gender,admission_date,occurance,sentence_months FROM biodata INNER JOIN crime ON biodata.pid=crime.pid";
...
if(isset($_GET['gosort']))
{
    ...
    if($value=='asc')
    {
        $query="SELECT biodata.NAME,offense,gender,age,occurance,admission_date,sentence_months FROM biodata INNER JOIN crime ON biodata.pid=crime.pid ORDER BY occurance";    }
    else
    {
        $query="SELECT biodata.NAME,offense,gender,age,occurance,admission_date,sentence_months FROM biodata INNER JOIN crime ON biodata.pid=crime.pid ORDER BY occurance DESC";
    }
...
if(isset($_GET['range']))
{
    ...
    $query="SELECT biodata.NAME,offense,gender,age,admission_date,occurance,sentence_months FROM biodata INNER JOIN crime ON biodata.pid=crime.pid AND occurance BETWEEN '".$from."' AND '".$to."'";
    $res = mysqli_query($db,$query);
    $str = "";
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <div style="margin-top:50px;">
            ...
            <form action="crime2.blade.php" method="get" style="background-color:gainsboro;">
                ...
                <div style="background-color:gainsboro;">
                    <div style="padding-top:50px;">
                        ...
                        <div style="margin-left:190px;">
                            <span>
                                <input type="number" placeholder="DD" name="fday" class="date">
                                <input type="number" placeholder="MM" name="fmonth" class="date">
                                <input type="number" placeholder="YYYY" name="fyear" class="date">
                            </span>
        ...
        <table class="table table-dark table-striped">
            <thead>
                <tr class="rowhead">
                    ...
                    <th class="colhead">Occurance</th>
                    <th class="colhead">Admission Date</th>
                    <th class="colhead">Punishment</th>
                </tr>
            </thead>
            <tbody>
                <?php
