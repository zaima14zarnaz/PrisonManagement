...
$firstname = $lastname =  $gender = $phone = $address = $designation = $name = "";
$age = $salary = 0;
...
if(isset($_GET['go']))
{
    ...
    $update = "UPDATE employee SET name='$name',age=$age,phone_no='$phone',address='$address',post='$designation',gender='$gender',salary='$salary' WHERE eid=".$_SESSION['id'];
...
<html>
    ...
    <form method="get" action="supform.blade.php">
