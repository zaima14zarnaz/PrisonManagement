<?php
    ...
    $getUser = "SELECT biodata.NAME,offense,age,gender,admission_date,sentence_months FROM biodata INNER JOIN crime2 ON biodata.pid=crime2.pid";
...
if(isset($_GET['gosort']))
{
    ...
    if($value=='asc')
    {
        $query="SELECT biodata.NAME,offense,gender,age,admission_date,sentence_months FROM biodata INNER JOIN crime2 ON biodata.pid=crime2.pid ORDER BY admission_date";
    }
    else
    {
        $query="SELECT biodata.NAME,offense,gender,age,admission_date,sentence_months FROM biodata INNER JOIN crime2 ON biodata.pid=crime2.pid ORDER BY admission_date DESC";
    }
...
if(isset($_GET['range']))
{
    ...
    $query="SELECT biodata.NAME,offense,gender,age,admission_date,sentence_months FROM biodata INNER JOIN crime2 ON biodata.pid=crime2.pid AND admission_date BETWEEN '".$from."' AND '".$to."'";
    $res = mysqli_query($db,$query);
    $str = "";
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <div style="margin-top:50px;">
            ...
            <form action="biodata3.blade.php" method="get" style="background-color:gainsboro;">
