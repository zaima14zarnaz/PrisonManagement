...
if(isset($_GET['go']))
{
    ...
    $delete1="DELETE FROM crime2 WHERE pid=".$value;
    $delete2="DELETE FROM biodata WHERE pid=".$value;
    $delete3="DELETE FROM prisoner2 WHERE pid=".$value;
    if(isset($_GET['delCrime'])) mysqli_query($db,$delete1);
...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <form action="biodataDelete.blade.php" method="get">
    <table class="table table-dark table-striped">
        ...
        <div>
            <span><input type="checkbox" name="delCrime" style="margin-left:30px;margin-top:30px;margin-right:10px;><p style="display:inline;"><strong>Delete criminal record</strong></p></span>
            <span><input type="submit" name="go" value="go" class="inpbtn"><span>
        </div>
        </form>
