    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <a href="paroleInsert.blade.php"><h2 class="display-4" style="font-size:40px;">Add A New Entry</h2></a>
            <p>An option which allows you to add the basic background and current information of an inmate who has recently been recently granted parole. Information of a parolee must be entered as soon as possible to keep the current and updated.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section> 
    <div class="container" >
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="p-5">
            <a href="paroleDelete.blade.php"><h2 class="display-4" style="font-size:40px;">Delete A Record</h2></a>
            <p>When a criminal serving under parole has completed their sentence, all his related information has to be removed from the system.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <a href="paroleUpdate.blade.php"><h2 class="display-4" style="font-size:40px;">Update Any Existing Information</h2></a>
            <p>This section is to be used in case a parolee has been assigned a new parole officer or any new information concerning the inmate has surfaced. If a new month is passed, the sentence served field of each of the convicts are to be updated by one month.</p>
          </div>
        </div>
      </div>
    </div>
