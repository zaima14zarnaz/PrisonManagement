...
if(isset($_GET['go']))
{
    ...
    $delete1="DELETE FROM parole WHERE pid=".$value;
...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <form action="paroleDelete.blade.php" method="get">
    <table class="table table-dark table-striped">
            <thead>
                <tr class="rowhead">
                    ...
                    <th class="colhead">Parole Officer</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($res)){
                        ...
                        $str.="<td class='data'>".$row['period']."</td>";
