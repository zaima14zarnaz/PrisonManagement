...
$getUser = "SELECT biodata.NAME,offense,sentence_months,sentence_served,(sentence_months-sentence_served) as sentence_remaining,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid";
...
while($row = mysqli_fetch_array($res)){
    ...
    $str.="<td class='data'>".$row['sentence_months']." months"."</td>";
    $str.="<td class='data'>".$row['sentence_served']." months"."</td>";
    $str.="<td class='data'>".$row['sentence_remaining']." months"."</td>";
    $str.="</tr>";
    $i = $i + 1;
}
?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <div style="margin-top:50px;">
            ...
            <form action="biodata2.blade.php" method="get">
        ...
        <table class="table table-dark table-striped">
            <thead>
                <tr class="rowhead">
                    ...
                    <th class="colhead">Punisment</th>
                    <th class="colhead">Sentence Served</th>
                    <th class="colhead">Sentence Remaining</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                else 
                {
                    ...
                    $query = "SELECT biodata.NAME,offense,sentence_months,sentence_served,(sentence_months-sentence_served) as sentence_remaining,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid AND biodata.NAME LIKE '".$_GET['name']."%' AND age=".$_GET['age']." AND gender LIKE '".$_GET['gender']."%' AND address LIKE '".$_GET['address']."%' AND cell_no=".$_GET['cell']."";
                    else if(empty($_GET['age']) && empty($_GET['cell'])) $query = "SELECT biodata.NAME,offense,sentence_months,sentence_served,(sentence_months-sentence_served) as sentence_remaining,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid AND biodata.NAME LIKE '".$_GET['name']."%'  AND gender LIKE '".$_GET['gender']."%' AND address LIKE '".$_GET['address']."%'";
                    else if(!empty($_GET['age']) && empty($_GET['cell'])) $query = "SELECT biodata.NAME,offense,sentence_months,sentence_served,(sentence_months-sentence_served) as sentence_remaining,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid AND biodata.NAME LIKE '".$_GET['name']."%' AND age=".$_GET['age']." AND gender LIKE '".$_GET['gender']."%' AND address LIKE '".$_GET['address']."%'";
