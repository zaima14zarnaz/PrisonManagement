<html>
  ...
  <?php
        $group="SELECT COUNT(eid) as num, area_label,type FROM employee GROUP BY area_label HAVING type='cleaning' ORDER BY area_label";
        ...
        while($row = mysqli_fetch_array($res))
        {
            ...
            while($col = mysqli_fetch_array($newres))
            {
                ...
                echo "<div style='position:relative;padding-top:8px;padding-bottom:4px;'><p class='undername'>Phone No : ".$col['phone_no']."</p><p class='besidename'>Address : ".$col['address']."</p></div>";
                echo "<div style='position:relative;padding-bottom:8px;'><p class='undername'>Shift Hours : ".$col['start'].":00-".$col['end'].":00</p><p class='besidename'>Salary : ".$col['salary']."</p></div>";
