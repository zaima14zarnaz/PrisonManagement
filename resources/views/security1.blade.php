<html>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="security.blade.php" style="color:black;">Queries</a>
          </li>
          <li class="nav-item">
  ...
  <?php
        $group="SELECT COUNT(eid) as num, post,type FROM employee GROUP BY post HAVING type='security'";
        ...
        while($row = mysqli_fetch_array($res))
        {
            ...
            $record="SELECT name, address, phone_no, salary, post FROM employee WHERE post='$who' ORDER BY name";
            ...
            while($col = mysqli_fetch_array($newres))
            {
                ...
                echo "<div style='position:relative;padding-top:8px;padding-bottom:4px;'><p class='undername'>Post : ".$col['post']."</p><p class='besidename'>Address : ".$col['address']."</p></div>";
                echo "<div style='position:relative;padding-bottom:8px;'><p class='undername'>Phone No : ".$col['phone_no']."</p><p class='besidename'>Salary : ".$col['salary']."</p></div>";
