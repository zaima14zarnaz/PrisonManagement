<?php
    ...
    $getUser = "SELECT name,offense,age,gender,address,period,parole_officer FROM parole";
    ...
    while($row = mysqli_fetch_array($res)){
        ...
        $str.="<td class='data'>".$row['period']." months</td>";
        $str.="<td class='data'>".$row['parole_officer']."</td>";
        $str.="</tr>";
        $i = $i + 1;
    }
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <div style="margin-top:50px;">
            ...
            <form action="biodata5.blade.php" method="get">
                <div background-color:black;>
                    ...
                    <div><input type="text" placeholder="Parole Officer" class="inp" name="officer" style="width:950px;"></div>
        ...
        <table class="table table-dark table-striped">
            <thead>
                <tr class="rowhead">
                    ...
                    <th class="colhead">Peroid</th>
                    <th ckass="colhead">Parole Officer</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                else 
                {
                    $str="";
                    if(!empty($_GET['age']))
                    $query = "SELECT name,offense,age,gender,address,period,parole_officer FROM parole WHERE name LIKE '".$_GET['name']."%' AND age=".$_GET['age']." AND gender LIKE '".$_GET['gender']."%' AND address LIKE '".$_GET['address']."%' AND parole_officer LIKE '".$_GET['officer']."%'";
                    else if(empty($_GET['age'])) $query = "SELECT name,offense,age,gender,address,period,parole_officer FROM parole WHERE name LIKE '".$_GET['name']."%' AND address LIKE '".$_GET['address']."%' AND gender LIKE '".$_GET['gender']."%' AND parole_officer LIKE '".$_GET['officer']."%'";
