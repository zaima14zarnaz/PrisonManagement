      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          ...
          <?php 
            ...
            {
              echo "<a href='securityAdminInsert.blade.php'><h2 class='display-4' style='font-size:40px;'>Add A New Entry</h2></a>";
            }
            ?>
  ...
  <section> 
    <div class="container" >
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="p-5">
            <a href="securityDelete.blade.php"><h2 class="display-4" style="font-size:40px;">Delete A Record</h2></a>
            <p>On the designation of an employee from the Security and Correction department, all his or her concerning records must be erased from the system database.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <a href="securityUpdate.blade.php"><h2 class="display-4" style="font-size:40px;">Update Any Existing Information</h2></a>
            <p>In case any new information concerning an employee has surfaced, a promotion has occured or there has been a change in his or her shift hours, the information has to be updated in the system as soon as possible.</p>
          </div>
        </div>
      </div>
    </div>
