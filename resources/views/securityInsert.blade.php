...
if(isset($_GET['go']))
{
    ...
    if(empty($name) or empty($age) or empty($salary) or empty($address) or empty($gender) or empty($post) or empty($phone) or empty($specilaty));
    $db = mysqli_connect("localhost","root","","PrisonManagement");
    
    $getUser = "INSERT INTO employee(name,gender,age,phone_no,address,type,post,specialty,salary) VALUES('$name','$gender',$age,'$phone','$address','security','$post','$specialty','$salary')";
...
<html>
    ...
    <form method="get" action="securityInsert.blade.php">
