    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <a href="visitInsert.blade.php"><h2 class="display-4" style="font-size:40px;">Add A New Entry</h2></a>
            <p>An option which allows you to add the information of a visitor who has recently visited an inmate. Information of a newly arriving visitor must be entered as soon as possible to keep the current and updated.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section> 
    <div class="container" >
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="p-5">
            <a href="visitUpdate.blade.php"><h2 class="display-4" style="font-size:40px;">Update Any Existing Information</h2></a>
            <p>If any new information regarding a visitor has come to light or if a previous record is to be updated to eradicate any errors within the system, this option is to be used.</p>
          </div>
        </div>
      </div>
    </div>
