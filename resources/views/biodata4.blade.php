...
$getUser = "SELECT biodata.NAME,offense,fine_charged,fine_paid,finedue(fine_charged,fine_paid) as due,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid";
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <div style="margin-top:50px;">
            ...
            <form action="biodata4.blade.php" method="get">
        ...
        <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                else 
                {
                    ...
                    $query = "SELECT biodata.NAME,offense,fine_charged,fine_paid,fine_due,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid AND biodata.NAME LIKE '".$_GET['name']."%' AND age=".$_GET['age']." AND gender LIKE '".$_GET['gender']."%' AND address LIKE '".$_GET['address']."%' AND cell_no=".$_GET['cell']."";
                    else if(empty($_GET['age']) && empty($_GET['cell'])) $query = "SELECT biodata.NAME,offense,fine_charged,fine_paid,fine_due,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid AND biodata.NAME LIKE '".$_GET['name']."%'";
                    else if(!empty($_GET['age']) && empty($_GET['cell'])) $query = "SELECT biodata.NAME,offense,fine_charged,fine_paid,fine_due,cell_no FROM biodata,crime2,prisoner2 WHERE prisoner2.pid = crime2.pid AND prisoner2.pid=biodata.pid AND biodata.NAME LIKE '".$_GET['name']."%' AND age=".$_GET['age']." AND gender LIKE '".$_GET['gender']."%' AND address LIKE '".$_GET['address']."%'";
                    ...
                    while($row = mysqli_fetch_array($res)){
                        if($i%2 == 0){
                            ...
                            $str.="<td class='data'>".$row['fine_charged']."</td>";
                            $str.="<td class='data'>".$row['fine_paid']."</td>";
                            $str.="<td class='data'>".$row['fine_due']."</td>";
                            $str.="</tr>";
                            $i = $i + 1;
                    }
                    echo $str;
